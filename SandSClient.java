...
public class SandSClient {  // begin class
    ...
    // ********** declaration of variables **********
        ...
        int[] list = new int[MAX];          // TEST ARRAY of size 50
        int actualLength = 0;
    ...
    // **************** create objects **********************
        ...
        ProgramInfo programInfo = new ProgramInfo(); //creating a new object 
        ArrayFunctions  arrayFunctions = new ArrayFunctions(MAX);
        Random rnd = new Random();
        
    // ********** Print output Banner **********
    
        System.out.println(programInfo.getBanner("Samarjeet Randhawa", "A2 Search and Sort"));
